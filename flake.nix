      ...
      categoryDefinitions =
        ...
        }@packageDef:
        {
          ...
          optionalPlugins = {
            ...
            notifications = with pkgs.vimPlugins; [
              (nvim-notify.overrideAttrs { doCheck = false; }) # TODO: remove overrideAttrs after check is fixed
              nui-nvim
              noice-nvim

            ];
            file-browsers = with pkgs.vimPlugins; [
              (nvim-tree-lua.overrideAttrs { pname = "nvim-tree"; }) # TODO: remove overrideAttrs after check is fixed
            ];
            general = {
              ...
              treesitter = with pkgs.vimPlugins; [
                ...
                (nvim-treesitter-context.overrideAttrs { pname = "treesitter-context"; }) # TODO: remove overrideAttrs after check is fixed
              ...
              git = with pkgs.vimPlugins; [
                gitsigns-nvim
                (lazygit-nvim.overrideAttrs { pname = "lazygit"; })
              ];
              always = with pkgs.vimPlugins; [
                nvim-lspconfig
                lualine-nvim
                (bufferline-nvim.overrideAttrs { pname = "bufferline"; }) # TODO: remove overrideAttrs after check is fixed
                vim-sleuth
                vim-fugitive
                vim-rhubarb
                nvim-surround

                # the directory name becomes nvim-tree.lua if you don't override;
              ];
